...
| 3 | Fetch API | Data is stored remotely in a backend provided by the instructor. I have no control over the backend, but I can store and retrieve data by sending HTTP requests through the frontend. |
